        ...
        <footer class="tweet-footer">
          <div class="tweet-interactions">
            <div class="interaction-item">
              <input type="image" src="/images/icon-comments${dark ? "-dark" : ""}.png" alt="image imput icon" class="comments-icon">
              <span class="interaction-value comments-number">0</span>
            </div>
            <div class="interaction-item">
              <input type="image" src="/images/icon-retweet${dark ? "-dark" : ""}.png" alt="image imput icon" class="retweet-icon">
              <span class="interaction-value retweet-number">0</span>
            </div>
            <div class="interaction-item">
              <input type="image" src="/images/icon-like${dark ? "-dark" : ""}.png" alt="image imput icon" class="like-icon">
              <span class="interaction-value like-number">0</span>
            </div>
            <div class="interaction-item">
              <input type="image" src="/images/icon-share${dark ? "-dark" : ""}.png" alt="image imput icon" class="share-icon">
